    ...
    <footer className="modern-footer">
      <div className="footer-content">
        <div className="footer-section brand">
          <h3>Why Join <span className="brand-highlight">Medilink</span>?</h3>
          <p>
            ...
            With just a few clicks, connect with licensed professionals ready to support your needs.
            <strong> Register today</strong> and take control of your well-being.
          </p>
        </div>
